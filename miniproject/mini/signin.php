  ...
  <body>
            ...
            <li class="nav-item dropdown">
             ...
             Authentication
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item" href="log.php"> CustomerLogin</a>
    ...
    <style>
        body {
            ...
            background-image: url("https://images.unsplash.com/photo-1518987048-93e29699e79a?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTl8fGNhcnN8ZW58MHx8MHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60");
                            ...
                            <div class="card-body">
                                ...
                                <form action="signup.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="txt" class="form-control" name="Address" id="Address" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="submit"  class="btn btn-outline-info btn-sm btn-block">SignUp</button>

                                </form>


                                <br>
                                <span>Already User ?</span> <a href="log.php" style="color:black;">Login</a>
